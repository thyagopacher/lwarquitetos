                    <p>
                        <label>Imagem - 1:<br>(600px 480px)</label><br>
                        <input type="file" name="imagem1" accept="image/*"/><br>
                        <?php echo("<img width='150' height='100' src='../visao/recursos/imagens/$produto[imagem1]' title='imagem 1' alt='imagem 1'/><br>");?>
                    ...
                    <p>
                        ...
                        <?php echo("<img width='150' height='100' src='../visao/recursos/imagens/$produto[imagem2]' title='imagem 2' alt='imagem 2'/><br>");?>
                    ...
                    <p>
                        ...
                        <?php echo("<img width='150' height='100' src='../visao/recursos/imagens/$produto[imagem3]' title='imagem 3' alt='imagem 3'/><br>");?>
                    ...
                    <p>
                        ...
                        <?php echo("<img width='150' height='100' src='../visao/recursos/imagens/$produto[imagem4]' title='imagem 4' alt='imagem 4'/><br>");?>
                    ...
                    <p>
                        ...
                        <?php echo("<img width='150' height='100' src='../visao/recursos/imagens/$produto[imagem5]' title='imagem 5' alt='imagem 5'/><br>");?>
                    ...
                    <p>
                        ...
                        <?php echo("<img width='150' height='100' src='../visao/recursos/imagens/$produto[imagem6]' title='imagem 6' alt='imagem 6'/><br>");?>
                    ...
                    <p>
                        ...
                        <?php echo("<img width='150' height='100' src='../visao/recursos/imagens/$produto[imagem7]' title='imagem 7' alt='imagem 7'/><br>");?>
                    ...
                    <p>
                        ...
                        <?php echo("<img width='150' height='100' src='../visao/recursos/imagens/$produto[imagem8]' title='imagem 8' alt='imagem 8'/><br>");?>
